...
var App = function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      var tweetlist = this.state.tweets.map(function (t) {
        return _react2.default.createElement(_Tweet2.default, { key: t.id, deleteParent: _this2.deleteParent.bind(_this2), content: t.content, author: t.author });
      });
