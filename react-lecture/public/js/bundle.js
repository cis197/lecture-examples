...
/******/ 	var hotCurrentHash = "eedfa09dbcbb0f0dfc90"; // eslint-disable-line no-unused-vars
...
var App = function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      var tweetlist = this.state.tweets.map(function (t, pos) {
        return _react2.default.createElement(_Tweet2.default, { key: pos, id: t.id, deleteParent: _this2.deleteParent.bind(_this2), content: t.content, author: t.author });
      });
